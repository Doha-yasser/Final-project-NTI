                        ...
                        <div class="menu-wrapper">
                            ...
                            <div class="nav-right-button border-left border-left-gray pl-4 mr-3">
                                <ul class="generic-list-item">
                                    ...
                                    <li>Or</li>
                                    <li><a href="signup" class="btn theme-btn theme-btn-sm text-white"><i class="la la-user-plus mr-1"></i> Register</a></li>
                                </ul>
        ...
        <div class="container">
            ...
            <div class="course-carousel owl-action-styled owl--action-styled mt-50px">
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="images/abb0dfa57c91867c3b9dc324ddf081cc.jpg" alt="Card image cap">
                        </a>
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a href="course-details.html">Cyber Security</a></h5>
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="images/4d771383de42c87535f4e3d981edb4a0.jpg" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                            <div class="course-badge">Bestseller</div>
                        </div>
                    ...
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                        <h5 class="card-title"><a href="course-details.html">AI</a></h5>
                        <p class="card-text"><a href="teacher-detail.html">Losy</a></p>
                        <div class="rating-wrap d-flex align-items-center py-2">
                            <div class="review-stars">
                                <span class="rating-number">4.4</span>
                                <span class="la la-star"></span>
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="images/1af52f9e4748e9a2d52406b1cf140946.jpg" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                    ...
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                        <h5 class="card-title"><a href="course-details.html">fullstuck</a></h5>
                        <p class="card-text"><a href="teacher-detail.html">Loai</a></p>
                        <div class="rating-wrap d-flex align-items-center py-2">
                            <div class="review-stars">
                                <span class="rating-number">4.4</span>
                                <span class="la la-star"></span>
