        ...
        <li>
            <div class="shop-cart-btn">
                <div class="avatar-xs">
                    @if (session('user')->image != null)
                        <img class="rounded-full img-fluid" src="{{ asset(session('user')->image) }}" alt="Student thumbnail image">
                    @else
                        <img class="rounded-full img-fluid" src="{{ asset('images/small-avatar-1.jpg') }}"
            ...
            <ul class="cart-dropdown-menu after-none p-0 notification-dropdown-menu">
                <li class="menu-heading-block d-flex align-items-center">
                    <a href="{{ route('profile.index') }}" class="avatar-sm flex-shrink-0 d-block">
                        @if (session('user')->image != null)
                        <img class="rounded-full img-fluid" src="{{ asset(session('user')->image) }}" alt="Student thumbnail image">
                    @else
                        <img class="rounded-full img-fluid" src="{{ asset('images/small-avatar-1.jpg') }}"
                    ...
                    <div class="ml-2">
                        <h4><a href="{{ route('profile.index') }}" class="text-black">{{ session('user')->name }}</a></h4>
