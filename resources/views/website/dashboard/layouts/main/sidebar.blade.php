<div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
    ...
    <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
        ...
        <li class="{{Route::is('dashboard') ? 'page-active' : ''}}"><a href="mycourses"><svg class="mr-2"
                    xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none"></path>
                    <path
        ...
        <li class="{{Route::is('dashboard') ? 'page-active' : ''}}"><a href="enrollstudent"><svg class="mr-2"
        ...
        <li class="{{Route::is('dashboard') ? 'page-active' : ''}}"><a href="submitcourse"><svg class="mr-2"
                    xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none"></path>
                    <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                </svg> Submit Course</a></li>
        <li class="{{Route::is('storage.course') ? 'page-active' : ''}}"><a href="submitcourse"><svg class="mr-2"
                    xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none"></path>
                    <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                </svg>storage</a></li>

        <li><a href="/"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24"
                    width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none"></path>
                    <path
