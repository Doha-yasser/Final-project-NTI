...
================================= -->
        <div class="container-fluid">
            ...
            <div class="dashboard-heading mb-5">
                <h3 class="fs-22 font-weight-semi-bold">{{__("site.Dashboard")}}</h3>
            </div>
        </div>
            <div class="row">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">{{__("site.Enrolled Courses")}}</p>
                                <h5 class="card-title pt-2 fs-26">{{$enrolledCorses}}</h5>
                            </div>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col-lg-4 -->
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">{{__("site.mycourses")}}</p>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">{{__("site.storage")}}</p>
                                <h5 class="card-title pt-2 fs-26">{{$storage}}</h5>
                            </div>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col-lg-4 -->
