...
<header class="header-menu-area">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        ...
                        <div class="menu-wrapper">
                            <form  class="mr-auto ml-0">
                                <div >
                                    <input class="form-control form--control form--control-gray pl-3" placeholder="Search for anything">
                                                ...
                                                <ul class="cart-dropdown-menu after-none p-0 notification-dropdown-menu">
                                                    ...
                                                    <li>
                                                        <div class="notification-body">
                                                            <a href="daashboardinstructor" class="media media-card align-items-center">
                                                            ...
                                                            <a href="dashboardinstructor" class="media media-card align-items-center">
                                                    ...
                                                    <li class="menu-heading-block">
                                                        <a href="#" class="btn theme-btn w-100">Show All Notifications <i class="la la-arrow-right icon ml-1"></i></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                            ...
                                            <li>
                                                ...
                                                <ul class="cart-dropdown-menu after-none p-0 notification-dropdown-menu">
                                                    <li class="menu-heading-block d-flex align-items-center">
                                                        ...
                                                        <div class="ml-2">
                                                            <h4><a href="teacher-detail.html" class="text-black">DR:Ali Ahmed</a></h4>
                                                            <span class="d-block fs-14 lh-20">ali88@example.com</span>
                                                        </div>
                                                    </li>
                                                    <li>
    ...
    <div class="off-canvas-menu custom-scrollbar-styled main-off-canvas-menu">
        ...
        <ul class="generic-list-item off-canvas-menu-list pt-1 pb-2 border-bottom border-bottom-gray">
            <li><a href="instructorProfile">Public profile</a></li>
    ...
    <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
        ...
        <div class="logo-box px-4">
         ...
         <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
            <li ><a href="dashboardinstructor"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/></svg> Dashboard</a></li>
            <li><a href="dashboardProfile-Ins"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 5.9c1.16 0 2.1.94 2.1 2.1s-.94 2.1-2.1 2.1S9.9 9.16 9.9 8s.94-2.1 2.1-2.1m0 9c2.97 0 6.1 1.46 6.1 2.1v1.1H5.9V17c0-.64 3.13-2.1 6.1-2.1M12 4C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 9c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4z"/></svg> My Profile</a></li>
            <li class="page-active"><a href="mycourses"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg> My Courses</a></li>
            <li><a href="enrollstudent"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="18px" viewBox="0 0 24 24" width="18px"><g><rect fill="none" height="24" width="24"/></g><g><path d="M11,21h-1l1-7H7.5c-0.88,0-0.33-0.75-0.31-0.78C8.48,10.94,10.42,7.54,13.01,3h1l-1,7h3.51c0.4,0,0.62,0.19,0.4,0.66 C12.97,17.55,11,21,11,21z"/></g></svg>Enroll Students</a></li>

           
            
     
            <li><a href="submitcourse"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg> Submit Course</a></li>
        ...
        <div class="container-fluid">
            <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
                <div class="media media-card align-items-center">
                    ...
                    <div class="media-body">
                        <h2 class="section__title fs-30">DR:Ali Ahmed</h2>
            ...
            <div class="dashboard-cards mb-5">
                <div class="card card-item card-item-list-layout">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="#">Ahmed Ali</a></p>
                ...
                <div class="card card-item card-item-list-layout">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="images/42ec2702587601f4a560296e92414656.jpg" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                            <div class="course-badge">Bestseller</div>
                            <div class="course-badge blue">-39%</div>
                    ...
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                        <h5 class="card-title"><a href="#">MYSQL</a></h5>
                        <p class="card-text"><a href="#">Ahmed Ali</a></p>
                        <div class="rating-wrap d-flex align-items-center py-2">
                            <div class="review-stars">
                                <span class="rating-number">4.4</span>
                ...
                <div class="card card-item card-item-list-layout">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="images/8aa74e12a7ef784a66b737acd86648a7.jpg" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                            <div class="course-badge">Bestseller</div>
                            <div class="course-badge blue">-39%</div>
                ...
                <div class="card card-item card-item-list-layout">
                    ...
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                        <h5 class="card-title"><a href="course-details.html">UI/UX</a></h5>
                        <p class="card-text"><a href="teacher-detail.html">Ahmea Ali</a></p>
                        <div class="rating-wrap d-flex align-items-center py-2">
                            <div class="review-stars">
                                <span class="rating-number">4.4</span>
                                <span class="la la-star"></span>
