        ...
        <div class="hero-slider-item hero-bg-2">
            <div class="container">
                <div class="hero-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-65 lh-80 pb-3">{{__("site.Join Aduca & Get")}} <br> {{__("site.Your Free Courses!")}}</h2>
                            ...
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="#" class="d-block">
                                        <img class="card-img-top lazy" src="images/817ad1b23ccd08bd68d6b61a39a1310b.png"
                                            data-src="images/817ad1b23ccd08bd68d6b61a39a1310b.jpg" alt="Card image cap">
                                    </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><a href="#">The Business Intelligence Analyst </a></h5>
    ...
    <div class="course-wrapper">
        <div class="container">
            ...
            <div class="course-carousel owl-action-styled owl--action-styled mt-30px">
                @foreach ($latestCourses as $course )
                    @include('website.home.includes.suggest')
                @endforeach
                <!-- end card -->
            </div><!-- end tab-content -->
        </div><!-- end container -->
...
<!--======================================
        START ABOUT AREA
======================================-->
<section class="about-area section--padding overflow-hidden pt-60px pb-60px bg-gray">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                    ...
                    <div class="row pt-4 pb-3">
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">{{__("site.expert instructors")}}</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                    </div><!-- end row -->
